  ...
  ngOnInit() {
    this.userService.getUserProfile().subscribe(
      res => {
        ...
        this.model.userType = this.userDetails['userType'];
        ...
        this.model.liscence = this.userDetails['liscence'];
        this.model.vehical_type = this.userDetails['vehical_type'];
        this.model.capacity = this.userDetails['capacity'];
